...
@Entity
@Table(name = "t_banquet_log", schema = "banquet1125", catalog = "")
public class TBanquetLogEntity {
    private String logId;
    private String banquetId;
    private int banquetStage;
    ...
    @Basic
    @Column(name = "banquetStage")
    public int getBanquetStage() {
        return banquetStage;
    }

    public void setBanquetStage(int banquetStage) {
    ...
    public boolean equals(Object o) {
        ...
        TBanquetLogEntity that = (TBanquetLogEntity) o;

        if (banquetStage != that.banquetStage) return false;
